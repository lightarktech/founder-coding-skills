...
- **Spend to the meters, not to habit.** "Cheap hands" is a pressure response, not a religion. Once dispatch discipline has cut your fleet frequency down, check the meters: with comfortable headroom at your actual cadence, default your workers to the strongest tier the budget sustains — you are buying fewer errors and fewer retries, which is usually cheaper than redoing sonnet-grade work. Downshift when the meters tighten. The meters set the tier; frugality theater does not.
